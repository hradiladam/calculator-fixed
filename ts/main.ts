...
document.addEventListener('DOMContentLoaded', () => {
    const historyElement = document.getElementById('recent-history') as HTMLElement;   // Get recent-history element
    const resultElement = document.getElementById('result') as HTMLElement;            // Get result element
    const themeButton = document.getElementById('theme-switch') as HTMLElement;        // Get dark theme switch button
