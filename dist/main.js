...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const historyElement = document.getElementById('recent-history'); // one-line history
    const resultElement = document.getElementById('result'); // result output
    // —— Grab history panel toggle and container ——
    const toggleBtn = document.getElementById('history-toggle'); // history button
    const panelEl = document.getElementById('history-panel'); // slide-out panel
